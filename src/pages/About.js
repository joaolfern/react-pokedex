...
function About() {
    return (
        <div className='about'>
            ...
            and <a href='https://www.npmjs.com/package/number-to-color' target='_blank' rel="noopener noreferrer">number-to-color</a>, that allowed some really dynamic stats bars, dependecies. and also,
            <a href='https://loading.io/' target='_blank' rel="noopener noreferrer">loading.io</a>
            provided me a super cool loading spinner.
            </p>
                <p>
                    You can check the source code to this app <a href='https://github.com/joaoaoluiz/react-pokedex' target='_blank' rel="noopener noreferrer">
                        here</a> and to many more on my <a href='https://joaoaoluiz.github.io/portfolio/' target='_blank' rel="noopener noreferrer">portofolio page</a>.
            </p>
